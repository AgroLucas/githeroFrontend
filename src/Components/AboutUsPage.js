...
<div class="text-center mt-3 mt-md-5 ml-4 mr-4 mb-3">
    ...
    <p>Lucas Agrò :<br/> lucas.y.agro@student.vinci.be</p>
    <p>Anis Assaidi :<br/> anis.assaidi@student.vinci.be</p>
    <p>Bastien Boutte :<br/> bastien.boutte@student.vinci.be</p>
    <p>Baptiste Honnay :<br/> baptiste.honnay@student.vinci.be</p>    
